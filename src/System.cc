...
System::System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor,
               const bool bUseViewer):mSensor(sensor), mpViewer(static_cast<Viewer*>(NULL)), mbReset(false),mbActivateLocalizationMode(true),
        mbDeactivateLocalizationMode(false)
{
   ...
   //Choose to use pure localization mode
       ...
       //get the current absoulte path
        ...
        string strPathMap = "/home/dbstg/slam/ORB_SLAM2/orb2_ws/src/ORB_SLAM2-master/savedmap/corridor_complete_c.bin";
